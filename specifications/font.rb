class Font
  ...
  def self.nerd_font_download(nerd_font_path, download_folder)
    ...
    latest_version = (curl_headers 'https://github.com/ryanoasis/nerd-fonts/releases/latest')['location'].split('/')[-1]
    curl "https://raw.githubusercontent.com/ryanoasis/nerd-fonts/#{latest_version}/patched-fonts/#{nerd_font_path.gsub(' ', '%20')}",
